...
public class SparkController
{
    ...
    public ResponseEntity<Resource>body_bg() throws IOException {
        final ByteArrayResource inputStream = new ByteArrayResource(Files.readAllBytes(Paths.get(
                "src\\main\\webapp\\images\\body_bg.png"
        )));
    ...
    @GetMapping(value = "/JobsPerCompanyImage", produces = MediaType.IMAGE_JPEG_VALUE)
    public ResponseEntity<Resource>JobsPerCompanyImg() throws IOException {
        final ByteArrayResource inputStream = new ByteArrayResource(Files.readAllBytes(Paths.get(
                "src\\main\\webapp\\images\\Jobs Per Company.jpg"
        )));
        return ResponseEntity
                .status(HttpStatus.OK)
                .contentLength(inputStream.contentLength())
    ...
    @GetMapping(value = "/JobsPerCompanyWithoutConfImage", produces = MediaType.IMAGE_JPEG_VALUE)
    public ResponseEntity<Resource> JobsPerCompanyWithoutConfImg() throws IOException {
        final ByteArrayResource inputStream = new ByteArrayResource(Files.readAllBytes(Paths.get(
                "src\\main\\webapp\\images\\Jobs Per Company Without Confidential.jpg"
        )));
        return ResponseEntity
                .status(HttpStatus.OK)
                .contentLength(inputStream.contentLength())
    ...
    @GetMapping(value = "/JobsPerLocationImage", produces = MediaType.IMAGE_JPEG_VALUE)
    public ResponseEntity<Resource> JobsPerLocationImg() throws IOException {
        final ByteArrayResource inputStream = new ByteArrayResource(Files.readAllBytes(Paths.get(
                "src\\main\\webapp\\images\\Jobs Per Location.jpg"
        )));
        return ResponseEntity
                .status(HttpStatus.OK)
                .contentLength(inputStream.contentLength())
    ...
    @GetMapping(value = "/JobsPerSkillsImage", produces = MediaType.IMAGE_JPEG_VALUE)
    public ResponseEntity<Resource> JobsPerSkillsImg() throws IOException {
        final ByteArrayResource inputStream = new ByteArrayResource(Files.readAllBytes(Paths.get(
                "src\\main\\webapp\\images\\Jobs Per Skills.jpg"
        )));
        return ResponseEntity
                .status(HttpStatus.OK)
                .contentLength(inputStream.contentLength())
    ...
    @GetMapping(value = "/JobsPerTitleImage", produces = MediaType.IMAGE_JPEG_VALUE)
    public ResponseEntity<Resource> JobsPerTitleImg() throws IOException {
        final ByteArrayResource inputStream = new ByteArrayResource(Files.readAllBytes(Paths.get(
                "src\\main\\webapp\\images\\Jobs Per Title.jpg"
        )));
        return ResponseEntity
                .status(HttpStatus.OK)
                .contentLength(inputStream.contentLength())
    ...
    @GetMapping(value = "/JobsPerYearsofExperienceImage", produces = MediaType.IMAGE_JPEG_VALUE)
    public ResponseEntity<Resource> JobsPerYearsofExperience() throws IOException {
        final ByteArrayResource inputStream = new ByteArrayResource(Files.readAllBytes(Paths.get(
                "src\\main\\webapp\\images\\Jobs Per Years of Experience.jpg"
        )));
        return ResponseEntity
                .status(HttpStatus.OK)
                .contentLength(inputStream.contentLength())
...
//                "<img th:src='images/Jobs Per Company.jpg'/>\n" +
//                "\n" +
//                "</body>\n" +
//                "</html>";
    ...
    public ResponseEntity<String> Wuzzuf_JobsByCompany()
    {
        ...
        html = html + "</br> <img src = \"./src/main/resources/Graphs/JobsPerCompany.jpg\"> </br> ";

        // WP.BarChart_Data(CompanyName,CompanyNumber,"Jobs Per Company2");
        html = html + "</br> <img src = \"./src/main/resources/Graphs/JobsPerCompany2.jpg\"> </br> ";
    ...
    public ResponseEntity<String> Wuzzuf_JobsByTitle()
    {
        ...
        html = html + "</br> <img src = \"./src/main/resources/Graphs/Jobs Per Title.jpg\"> </br> ";
    ...
    public ResponseEntity<String> Wuzzuf_JobsByLocations()
    {
        ...
        html = html + "</br> <img src = \"./src/main/resources/Graphs/Jobs Per Location.jpg\"> </br> ";
    ...
    public ResponseEntity<String> Wuzzuf_JobsBySkills()
    {
        ...
        html = html + "</br> <img src = \"./src/main/resources/Graphs/Jobs Per Skills.jpg\"> </br> ";
    ...
    public ResponseEntity<String> Wuzzuf_JobsByYears()
    {
        ...
        html = html + "</br> <img src = \"./src/main/resources/Graphs/Jobs Per Years of Experience.jpg\"> </br> ";
    ...
    public String ML_Prediction_Title(Dataset<Row> DataFrame)
    {
        ...
        try
        {
            ...
            html = html + String.format(DFTrainTransform.select("TitleID","Title","YearsExp", "features").showString(20, 20, true));
    ...
    public String ML_Prediction_Company(Dataset<Row> DataFrame)
    {
        ...
        try
        {
            ...
            // --------------------------------------------------------------
            Dataset<Row> DFTrainTransform = vectorAssembler.transform(DFTrain.na().drop());
            html = html + String.format(DFTrainTransform.select("CompanyID","Company","YearsExp", "features").showString(20, 20, true));
